...
function layout_change(layout) {
  ...
  if (layout == 'dark') {
    ...
    dark_flag = false;
    if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
      document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', 'assets/img/logo-ekos.png');
    }
    if (document.querySelector('.navbar-brand .logo-lg')) {
      document.querySelector('.navbar-brand .logo-lg').setAttribute('src', 'assets/img/logo-ekos.png');
    }
    if (document.querySelector('.auth-main.v1 .auth-sidefooter')) {
