...
if (!isset($_GET['id']) || empty($_GET['id'])) {
    header("Location: /ekos/pages/admin/facility-kost.php");
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($facility_name)) {
        $stmt = $conn->prepare("UPDATE facilities SET facility_name = :facility_name WHERE facility_id = :facility_id");
        $stmt->execute([
        ...
        $error = "Nama fasilitas tidak boleh kosong.";
    }
}
...
// Jika data facilitas tidak ditemukan
if (!$facility) {
    header("Location: /ekos/pages/admin/facility-kost.php");
    exit();
}
...
<html lang="en">
<head>
    <title>eKos - Edit Fasilitas</title>
    <!-- [Meta] -->
    <meta charset="utf-8">
    ...
    <div class="pc-container">
        ...
        <div class="page-header">
            ...
            <div class="row align-items-center">
                ...
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/ekos/pages/admin/facility-kost.php">Kategori Kos</a></li>
                    <li class="breadcrumb-item" aria-current="page">Edit Fasilitas</li>
                </ul>
                </div>
            </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <form method="POST">
                                    ...
                                    <a href="/ekos/pages/admin/facility-kost.php" class="btn btn-secondary ms-2">Batal</a>
                                </form>
                            </div>
                        </div>
                    </div>
