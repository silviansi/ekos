...
<head>
    <title>eKos - Fasilitas Kos</title>
    <!-- [Meta] -->
    <meta charset="utf-8">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Fasilitas Kos</h5>
                            </div>
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Fasilitas Kos</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card table-card latest-activity-card">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <h5>Data Fasilitas Kos</h5>
                                <a href="add-facilities.php" class="btn btn-primary">Tambah Fasilitas</a>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-hover table-borderless">
                                        ...
                                        <tbody>
                                            <?php $no = 1; foreach ($facility as $facilities): ?>
                                            <tr>
                                                <td><?= $no++; ?></td>
                                                <td><?= htmlspecialchars($facilities['facility_name']); ?></td>
                                                <td>
