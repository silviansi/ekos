...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        header("Location: /ekos/pages/admin/category-kost.php?success=add");
        exit();
    } catch (PDOException $e) {
        $error = urlencode($e->getMessage());
        header("Location: /ekos/pages/admin/category-kost.php?error=$error");
        exit();
    }
}
?>
...
<html lang="en">
<head>
    <title>eKos - Tambah Kategori</title>
    <!-- [Meta] -->
    <meta charset="utf-8">
                            ...
                            <div class="col-md-12">
                                <form method="POST" action="">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="category_name" class="form-control" placeholder="Text">
                                    </div>
